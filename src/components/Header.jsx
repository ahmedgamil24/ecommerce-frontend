...
const Header = () => {
  return (
    ...
    <Container>
      <div className="header flex justify-around items-center py-4 ">
        ...
        {/* Search */}
        <div className="search w-xl border border-solid border-gray-300 h- rounded px-4 py-4 flex justify-between items-center bg-[#e5e5e5]">
          <input
            type="text"
